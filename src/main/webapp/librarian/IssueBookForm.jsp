...
<body style="background-image: url('../images/IssueBook.jpg'); background-repeat: no-repeat;background-size: cover;">
<div class="navbar navbar-inverse">
  ...
  <form action="../IssueBook" method="post" style="width:400px">
  <div class="form-group">
    <label for="callno1">Book Call No</label>
  ...
  <div class="form-group">
    <label for="author1">Student Name</label>
    <input type="text" class="form-control" name="studentname" id="author1" placeholder="Sahib Singh"/>
  </div>
  <div class="form-group">
    <label for="publisher1">Student Mobile</label>
  <input type="number" class="form-control" name="studentmobile" id="mobile1" placeholder="70010123"/>
    </div>
